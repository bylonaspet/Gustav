 ...
 */
.factory('ServicePrototype', ['$rootScope', '$cacheFactory', 'ngcsasCoreConstants', '$log', function ($rootScope, $cacheFactory, ngcsasCoreConstants, $log) {
    'use strict';
    var service = {
...
.factory('PluginManager', ['$ocLazyLoad', '$q', '$log', function ($ocLazyLoad, $q, $log) {
    'use strict';
...
.provider('Menu', ['ngcsasCoreConstants', function (ngcsasCoreConstants) {
    'use strict';
    var _menu = [];
    var rootScope = null;
