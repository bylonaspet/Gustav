...
angular.module('ngcsas.core', [
    ...
    .config(['$logProvider', '$translateProvider', 'tmhDynamicLocaleProvider', '$httpProvider', 'localStorageServiceProvider', function ($logProvider, $translateProvider, tmhDynamicLocaleProvider, $httpProvider, localStorageServiceProvider) {
        ...
        $httpProvider.interceptors.push(['$q', '$rootScope', 'ngcsasCoreConstants', '$log', function($q, $rootScope, ngcsasCoreConstants, $log){
            return {
