 ...
 */
angular.module('gustav.buildingSaving', ['ngcsas.core']).config(['$stateProvider', function ($stateProvider) {
    $stateProvider.state('buildingSaving', {
        ...
        resolve: {
            buildingSavings: ['BuildingSaving', function (BuildingSaving) {
 ...
 */
angular.module('gustav.buildingSaving').controller('BuildingSavingsCtrl', ['$scope', 'BuildingSaving', function ($scope, BuildingSaving) {
...
angular.module('gustav.buildingSaving').factory('BuildingSaving',
    ['$rootScope', '$resource', 'ServicePrototype', 'ENV', 'ngcsasCoreConstants', function($rootScope, $resource, ServicePrototype, ENV, ngcsasCoreConstants) {
