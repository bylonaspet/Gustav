 ...
 */
angular.module('gustav.account').factory('Account', ['$rootScope', '$resource', '$filter', 'ServicePrototype', 'ENV', 'ngcsasCoreConstants', function($rootScope, $resource, $filter, ServicePrototype, ENV, ngcsasCoreConstants) {
