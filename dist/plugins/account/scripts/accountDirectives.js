 ...
 */
angular.module('gustav.account').directive('accountBox', ['Account', function (Account) {
    return {
 ...
 */
angular.module('gustav.account').directive('accountContext', ['$compile', 'AccountContext', function ($compile, AccountContext) {
    return {
        template: '',
        restrict: 'EA',
        scope: {
