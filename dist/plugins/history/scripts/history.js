 ...
 */
angular.module('gustav.history', ['ngcsas.core', 'gustav.account']).config(['$stateProvider', function($stateProvider) {
    ...
    .config(['AccountContextProvider', function(AccountContextProvider) {
 ...
 */
.controller('HistoryCtrl', ['$scope', '$http', '$filter', '$stateParams', '$location', 'Account', 'History', 'accounts', function($scope, $http, $filter, $stateParams, $location, Account, History, accounts) {
    $scope.filter = {};
...
angular.module('gustav.history').factory('History',
    ['$rootScope', '$resource', 'ServicePrototype', 'ENV', function($rootScope, $resource, ServicePrototype, ENV) {
