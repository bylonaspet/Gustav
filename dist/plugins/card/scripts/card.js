 ...
 */
angular.module('gustav.card', ['ngcsas.core']).config(['$stateProvider', function ($stateProvider) {
 ...
 */
angular.module('gustav.card').controller('CardsCtrl', ['$scope', 'Card', function ($scope, Card) {
