 ...
 */
angular.module('gustav').controller('HomeCtrl', ['$scope', 'accounts', function($scope, accounts) {
 ...
 */
.controller('RootCtrl', ['$scope', '$rootScope', '$location', '$translate', 'tmhDynamicLocale', 'ENV', 'Menu', 'ngcsasCoreConstants', 'PluginManager', '$state', 'Profile', function(
    $scope, $rootScope,
