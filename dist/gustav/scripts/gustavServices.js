 ...
 */
.factory('Profile', ['$rootScope', '$resource', 'ServicePrototype', 'ENV', 'ngcsasCoreConstants', function($rootScope, $resource, ServicePrototype, ENV, ngcsasCoreConstants) {
 ...
 * Validate bank code.
 */
.directive('bankcode', ['Bic', function (Bic) {
    return {
        require: 'ngModel',
 ...
 */
.directive('accountnumber', ['Account', function (Account) {
    return {
        require: 'ngModel',
        link: function (scope, elm, attrs, ctrl) {
            ctrl.$parsers.unshift(function (viewValue) {
